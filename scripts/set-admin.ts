/**
 * Script utilitaire pour définir un utilisateur comme administrateur
 *
 * Usage:
 *   npx tsx scripts/set-admin.ts votre-email@example.com
 *
 * Ou avec ts-node:
 *   npx ts-node scripts/set-admin.ts votre-email@example.com
 */
...
if (!email) {
  ...
  console.log("\nUsage:");
  console.log("  npx tsx scripts/set-admin.ts votre-email@example.com");
  console.log("\nOu:");
  console.log("  npx ts-node scripts/set-admin.ts votre-email@example.com");
  process.exit(1);
}
